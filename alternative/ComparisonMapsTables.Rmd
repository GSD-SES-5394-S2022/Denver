...
ggsave("population_tract.pdf", existing_pop_map+
  scale_fill_viridis_c(option = "D",
                       begin = 1, end = 0,
                       name = "Tract Population",
                       breaks = size_brks <- seq(0, 15000, by = 2500),
...
proposed_pop_map + scale_fill_viridis_c(option = "D",
                       begin = 1, end = 0,
...
ggsave("proposed_population.pdf", proposed_pop_map +
    scale_fill_viridis_c(option = "D",
                       begin = 1, end = 0,
                       name = "Proposed Tract Population",
                       breaks = size_brks <- seq(0, 40000, by = 10000),
...
ggsave("existing_hh.pdf", existing_hh_map +
  scale_fill_viridis_c(option = "D",
                       begin = 1, end = 0,
                       name = "Tract Housing Units",
                       breaks = size_brks <- seq(0, 7000, by = 1000),
...
ggsave("existing_lowincome.pdf", existing_lowincome_map +
  scale_fill_viridis_c(option = "D",
                       begin = 1, end = 0,
                       name = "Low Income Households",
                       breaks = size_brks <- seq(0, 1200, by = 200),
...
ggsave("proposed_lowincome.pdf", proposed_lowincome_map +
  scale_fill_viridis_c(option = "D",
                       begin = 1, end = 0,
                       name = "Proposed Low Income Households",
                       breaks = size_brks <- seq(0, 2500, by = 500),
...
ggsave("existing_midincome.pdf", existing_midincome_map +
  scale_fill_viridis_c(option = "D",
                       begin = 1, end = 0,
                       name = "Mid Income Households",
                       breaks = size_brks <- seq(0, 2000, by = 500),
...
ggsave("existing_highincome.pdf", existing_highincome_map +
  scale_fill_viridis_c(option = "D",
                       begin = 1, end = 0,
                       name = "High Income Households",
                       breaks = size_brks <- seq(0, 3500, by = 1000),
...
ggsave("propose_highincome.pdf", proposed_highincome_map +
  scale_fill_viridis_c(option = "D",
                       begin = 1, end = 0,
                       name = "Proposed High Income Households",
                       breaks = size_brks <- seq(0, 12000, by = 2000),
...
ggsave("existing_nocar.pdf", existing_nocar_map +
  scale_fill_viridis_c(option = "D",
                       begin = 1, end = 0,
                       name = "Zero Car Households",
                       breaks = size_brks <- seq(0, 1200, by = 200),
...
ggsave("proposed_nocar.pdf", proposed_nocar_map +
  scale_fill_viridis_c(option = "D",
                       begin = 1, end = 0,
                       name = "Proposed Zero Car Households",
                       breaks = size_brks <- seq(0, 2000, by = 500),
...
ggsave("existing_oneperson.pdf", existing_oneperson_map +
  scale_fill_viridis_c(option = "D",
                       begin = 1, end = 0,
                       name = "One-Person Households",
                       breaks = size_brks <- seq(0, 3000, by = 500),
...
ggsave("proposed_oneperson.pdf", proposed_oneperson_map +
  scale_fill_viridis_c(option = "D",
                       begin = 1, end = 0,
                       name = "Proposed One-Person Households",
                       breaks = size_brks <- seq(0, 8000, by = 1200),
...
ggsave("existing_twoperson.pdf", existing_twoperson_map +
  scale_fill_viridis_c(option = "D",
                       begin = 1, end = 0,
                       name = "Two-Person Households",
                       breaks = size_brks <- seq(0, 2500, by = 500),
...
ggsave("proposed_twoperson.pdf", proposed_twoperson_map +
  scale_fill_viridis_c(option = "D",
                       begin = 1, end = 0,
                       name = "Proposed Two-Person Households",
                       breaks = size_brks <- seq(0, 10000, by = 2000),
...
ggsave("existing_basic.pdf", existing_basic_map +
  scale_fill_viridis_c(option = "D",
                       begin = 1, end = 0,
                       name = "Basic Employees",
                       breaks = size_brks <- seq(0, 15000, by = 3000),
...
ggsave("proposed_basic.pdf", proposed_basic_map +
  scale_fill_viridis_c(option = "D",
                       begin = 1, end = 0,
                       name = "Proposed Basic Employees",
                       breaks = size_brks <- seq(0, 30000, by = 5000),
...
ggsave("existing_service.pdf", existing_service_map +
  scale_fill_viridis_c(option = "D",
                       begin = 1, end = 0,
                       name = "Service Employees",
                       breaks = size_brks <- seq(0, 60000, by = 10000),
...
ggsave("proposed_service.pdf", proposed_service_map +
  scale_fill_viridis_c(option = "D",
                       begin = 1, end = 0,
                       name = "Proposed Service Employees",
                       breaks = size_brks <- seq(0, 90000, by = 15000),
...
ggsave("existing_retail.pdf", existing_retail_map +
  scale_fill_viridis_c(option = "D",
                       begin = 1, end = 0,
                       name = "Retail Employees",
                       breaks = size_brks <- seq(0, 5000, by = 1000),
...
ggsave("proposed_retail.pdf", proposed_retail_map +
  scale_fill_viridis_c(option = "D",
                       begin = 1, end = 0,
                       name = "Proposed Retail Employees",
                       breaks = size_brks <- seq(0, 15000, by = 2500),
