...
###Arvada
``` {r}
write_csv(arvada_tracts_R6, 
          "data/arvada/tract_arvada6.csv", 
          append = FALSE)
write_csv(arvada_tracts_R13, 
          "data/arvada/tract_arvada13.csv", 
          append = FALSE)
write_csv(arvada_tracts_R24, 
          "data/arvada/tract_arvada24.csv", 
          append = FALSE)
...
###Aurora
``` {r}
write_csv(aurora_tracts_R3, 
          "data/aurora/tract_aurora3.csv", 
          append = FALSE)
write_csv(aurora_tracts_R4, 
          "data/aurora/tract_aurora4.csv", 
          append = FALSE)
...
###Denver
```{r}
write_csv(denver_tracts_3, 
          "data/denver/tract_denver3.csv", 
          append = FALSE)
write_csv(denver_tracts_5, 
          "data/denver/tract_denver5.csv", 
          append = FALSE)
write_csv(denver_tracts_8, 
          "data/denver/tract_denver8.csv", 
          append = FALSE)
write_csv(denver_tracts_12, 
          "data/denver/tract_denver12.csv", 
          append = FALSE)
write_csv(denver_tracts_20, 
          "data/denver/tract_denver20.csv", 
          append = FALSE)
write_csv(denver_tracts_2.5, 
          "data/denver/tract_denver2.5.csv", 
          append = FALSE)
```