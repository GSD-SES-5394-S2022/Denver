...
In Colorado, the poverty level is defined as a household income of .... based on this threshold, we'll use ... (explain your reasoning...)
...
```{r}
write_csv(st_drop_geometry(zones), here("existing", "data", "zone_data.csv"))
```
