...
alt_HBO_PMT_car <- alt_skims %>%
  ...
  select(alt_n_SOV_HBO, alt_n_HOV_HBO, miles) %>%
  mutate(alt_PMT_SOV_HBO = alt_n_SOV_HBO * miles,
         alt_PMT_HOV_HBO = alt_n_HOV_HBO * miles) %>%
...
alt_HBO_PMT_bike <- alt_skims %>%
  ...
  select(alt_n_bike_HBO, miles) %>%
  mutate(alt_PMT_bike_HBO = alt_n_bike_HBO * miles) %>%
...
alt_HBO_PMT_walk <- alt_skims %>%
  ...
  select(alt_n_walk_HBO, miles) %>%
  mutate(alt_PMT_walk_HBO = alt_n_walk_HBO * miles) %>%
...
alt_HBW_PMT_car <- alt_skims %>%
  left_join(alt_drive_dist, by = c("fromId", "toId")) %>%
  select(alt_n_SOV_HBW, alt_n_HOV_HBW, miles) %>%
  mutate(alt_PMT_SOV_HBW = alt_n_SOV_HBW * miles,
         alt_PMT_HOV_HBW = alt_n_HOV_HBW * miles) %>%
...
alt_HBW_PMT_bike <- alt_skims %>%
  left_join(alt_bike_dist, by = c("fromId", "toId")) %>%
  select(alt_n_bike_HBW, miles) %>%
  mutate(alt_PMT_bike_HBW = alt_n_bike_HBW * miles) %>%
...
alt_HBW_PMT_walk <- alt_skims %>%
  left_join(alt_ped_dist, by = c("fromId", "toId")) %>%
  select(alt_n_walk_HBW, miles) %>%
  mutate(alt_PMT_walk_HBW = alt_n_walk_HBW * miles) %>%
...
alt_NHB_PMT_car <- alt_skims %>%
  left_join(alt_drive_dist, by = c("fromId", "toId")) %>%
  select(alt_n_SOV_NHB, alt_n_HOV_NHB, miles) %>%
  mutate(alt_PMT_SOV_NHB = alt_n_SOV_NHB * miles,
         alt_PMT_HOV_NHB = alt_n_HOV_NHB * miles) %>%
...
alt_NHB_PMT_bike <- alt_skims %>%
  left_join(alt_bike_dist, by = c("fromId", "toId")) %>%
  select(alt_n_bike_NHB, miles) %>%
  mutate(alt_PMT_bike_NHB = alt_n_bike_NHB * miles) %>%
...
alt_NHB_PMT_walk <- alt_skims %>%
  left_join(alt_ped_dist, by = c("fromId", "toId")) %>%
  select(alt_n_walk_NHB, miles) %>%
  mutate(alt_PMT_walk_NHB = alt_n_walk_NHB * miles) %>%
